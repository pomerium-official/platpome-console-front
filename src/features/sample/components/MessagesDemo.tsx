...
const MessagesDemo = () => {
  ...
  const addSuccessMessage = () => {
    message.current?.show({ severity: 'success', detail: 'Message Detail' });
  };

  const addInfoMessage = () => {
    message.current?.show({ severity: 'info', detail: 'Message Detail' });
  };

  const addWarnMessage = () => {
    message.current?.show({ severity: 'warn', detail: 'Message Detail' });
  };

  const addErrorMessage = () => {
    message.current?.show({ severity: 'error', detail: 'Message Detail' });
  };
