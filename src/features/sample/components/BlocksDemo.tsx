...
<div className="grid grid-nogutter surface-section text-800">
    ...
    <div className="col-12 md:col-6 overflow-hidden">
        <img src="/assets/sample/images/blocks/hero/hero-1.png" alt="hero-1" className="md:ml-auto block md:h-full" style={{ clipPath: 'polygon(8% 0, 100% 0%, 100% 100%, 0 100%)' }} />
    </div>
</div>
    `;
...
<div className="surface-card p-4 shadow-2 border-round w-full lg:w-6">
    <div className="text-center mb-5">
        <img src="/assets/sample/images/blocks/logos/hyper.svg" alt="hyper" height="50" className="mb-3" />
    ...
    <>
      <BlockViewer header="Hero" code={block1}>
        <div className="grid grid-nogutter surface-section text-800">
          ...
          <div className="col-12 md:col-6 overflow-hidden">
            <img
              src="/assets/sample/images/blocks/hero/hero-1.png"
              alt="hero-1"
      ...
      >
        <div className="surface-card p-4 shadow-2 border-round w-full lg:w-6">
          <div className="text-center mb-5">
            <img
              src="/assets/sample/images/blocks/logos/hyper.svg"
              alt="hyper"
              height="50"
              className="mb-3"
            />
