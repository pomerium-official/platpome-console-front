...
import { Product, ProductService } from '@/apis/sample/service/ProductService';
...
const OverlayDemo = () => {
  ...
  const toggle: React.MouseEventHandler<HTMLButtonElement> = (event) => {
    op.current?.toggle(event);
  };

  const toggleDataTable: React.MouseEventHandler<HTMLButtonElement> = (
    event
  ) => {
  ...
  const imageBodyTemplate = (data: Product) => (
    <img
      src={`/assets/sample/images/product/${data.image}`}
  ...
  const priceBodyTemplate = (data: Product) => formatCurrency(data.price);
          ...
          <div className="card p-fluid">
            ...
            <div className="grid formgrid">
              <div className="col-6">
                ...
                <OverlayPanel
                  ref={op}
                  appendTo={isServer ? undefined : document?.body}
                  showCloseIcon
                >
                  <img
                    src="/assets/sample/images/nature/nature9.jpg"
                    alt="nature1"
                  />
                </OverlayPanel>
              </div>
