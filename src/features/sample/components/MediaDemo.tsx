...
import { Photo, PhotoService } from '@/apis/sample/service/PhotoService';
...
const MediaDemo = () => {
  ...
  const carouselItemTemplate = (product: Product) => {
    return (
  ...
  const galleriaItemTemplate = (item: Photo) => (
    <img
  ...
  const galleriaThumbnailTemplate = (item: Photo) => (
    <img
      ...
      <div className="col-12">
        <div className="card">
          ...
          <div className="flex justify-content-center">
            <Image
              src="/assets/sample/images/galleria/galleria11.jpg"
              alt="galleria"
              width={'250px'}
              preview
            />
