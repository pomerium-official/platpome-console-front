    ...
    <div className="grid">
      ...
      <div className="col-12 lg:col-6">
        <div className="card">
          ...
          <Badge value="12" severity="warn" className="mr-2" />
          ...
          >
            <Badge value="8" severity="error" />
          </Button>

          <h5>Sizes</h5>
          <Badge value="2" className="mr-2" />
          <Badge value="4" className="mr-2" size="large" severity="warn" />
        ...
        <div className="card">
          ...
          <AvatarGroup className="mb-3">
            <Avatar
              image="/assets/sample/images/avatar/amyelsner.png"
              size="large"
              shape="circle"
            />
            <Avatar
              image="/assets/sample/images/avatar/asiyajavayant.png"
              size="large"
              shape="circle"
            />
            <Avatar
              image="/assets/sample/images/avatar/onyamalimba.png"
              size="large"
              shape="circle"
            />
            <Avatar
              image="/assets/sample/images/avatar/ionibowcher.png"
              size="large"
              shape="circle"
            />
            <Avatar
              image="/assets/sample/images/avatar/xuxuefeng.png"
              size="large"
              shape="circle"
            />
            <Avatar
      ...
      <div className="col-12 lg:col-6">
        <div className="card">
          ...
          <Tag className="mr-2" severity="warn" value="Warning" />
          <Tag severity="error" value="Danger" />

          <h5>Pills</h5>
          <Tag className="mr-2" value="Primary" rounded />
          <Tag className="mr-2" severity="success" value="Success" rounded />
          <Tag className="mr-2" severity="info" value="Info" rounded />
          <Tag className="mr-2" severity="warn" value="Warning" rounded />
          <Tag severity="error" value="Danger" rounded />
          ...
          <Tag
            ...
            value="Warning"
          />
          <Tag icon="pi pi-times" severity="error" value="Danger" />
        </div>
