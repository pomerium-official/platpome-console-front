...
import { NodeService } from '@/apis/sample/service/NodeService';
import TreeNode from 'primereact/treenode';

export const InputDemo = () => {
  const [floatValue, setFloatValue] = useState('');
  const [autoValue, setAutoValue] = useState<CountryData[]>();
  const [selectedAutoValue, setSelectedAutoValue] = useState(null);
  const [autoFilteredValue, setAutoFilteredValue] = useState<CountryData[]>([]);
  ...
  const itemTemplate: MultiSelectItemTemplateType = (option) => {
    return (
  ...
  const selectedItemTemplate: MultiSelectSelectedItemTemplateType = (
    option
  ) => {
    if (option) {
      return (
        ...
        <div className="card">
          <div className="grid">
            ...
            <div className="col-12 md:col-6">
              ...
              <Rating
                value={ratingValue}
                onChange={(e) => setRatingValue(e.value ?? undefined)}
              />
            </div>
            <div className="col-12 md:col-6">
              <h5>ColorPicker</h5>
